...
export interface IIamService {
    ...
    updateResource(resourceId: string, update: Partial<IResource>): Promise<IResource | null>;
    ...
    updatePermission(permissionId: string, update: Partial<IPermission>): Promise<IPermission | null>;
